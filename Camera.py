...
# TODO
# 1. brojanje repsa
# 2. koljena da nisu predalkeo i da nisu preblizu da ne idu u x
# 3. idemo li doboljno duboko
#
...
while cv2.waitKey(1) < 0:
    ...
    for pair in POSE_PAIRS:
        ...
        if points[partA] and points[partB]:
            key = (tuple(pair), frameCounter)
            value = (points[partA], points[partB])
    ...
    squat_counter(key_points)
    vid_writer.write(frame)

#TODO napraviti checkpointe, gledati kada tocka dupeta dode dovljno nisko da broji
#TODO napraviti da pazi da je udeljnost koljena ista kao i stopala, ili male oscialcije
import sys
